...
SELECT
    ...
    DATE_PART(EPOCH_SECOND, commission.SRC:locking_date::TIMESTAMPNTZ)::NUMBER AS paid_datetime_unixtime,
    ...
    (commission.SRC:Client_Cost::NUMBER - ZEROIFNULL(commission.SRC:Payout)::NUMBER)::NUMBER(15, 4) AS agency_commission,
